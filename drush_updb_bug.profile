 ...
 */
function drush_updb_bug_profile_modules() {
  return array(
    // core modules
 ...
 */
function drush_updb_bug_profile_tasks(&$task, $url) {
  ...
  // another try at clearing caches
  drupal_flush_all_caches();

}

/**
 * Enable the 'acquia_marina' theme
 */
function drush_updb_bug_profile_enable_custom_theme() {
  install_disable_theme('garland');
  install_default_theme('acquia_marina');
  install_default_theme('acquia_marina');
}
